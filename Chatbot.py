...
# This will store the created RAG chain to avoid recreating it
        ...
        if not uploaded_files:
            ...
            with st.spinner("Processing documents... This may take a moment."):
                ...
                for uploaded_file in uploaded_files:
                    # Save the uploaded file to a temporary location to be read by PyPDFLoader
                ...
                # Prompt to contextualize question based on history
                ...
                # Prompt to answer the question based on retrieved context
                qa_system_prompt = (
